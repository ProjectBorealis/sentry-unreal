...
- Bump Java SDK (Android) from v8.25.0 to v8.37.0 ([#62](https://github.com/ProjectBorealis/sentry-unreal/pull/62))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8370)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.37.0)
