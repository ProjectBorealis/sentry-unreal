...
- Bump Android Gradle Plugin from v5.12.1 to v6.8.1 ([#95](https://github.com/ProjectBorealis/sentry-unreal/pull/95))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#681)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.8.1)
