...
- Bump Android Gradle Plugin from v5.12.1 to v6.1.0 ([#40](https://github.com/ProjectBorealis/sentry-unreal/pull/40))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#610)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.1.0)
