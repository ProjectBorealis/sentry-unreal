...
- Bump Java SDK (Android) from v8.25.0 to v8.34.0 ([#50](https://github.com/ProjectBorealis/sentry-unreal/pull/50))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8340)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.34.0)
