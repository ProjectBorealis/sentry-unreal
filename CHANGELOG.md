...
- Bump Java SDK (Android) from v8.25.0 to v8.42.0 ([#93](https://github.com/ProjectBorealis/sentry-unreal/pull/93))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8420)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.42.0)
