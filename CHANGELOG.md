...
- Bump Java SDK (Android) from v8.25.0 to v8.52.0 ([#143](https://github.com/ProjectBorealis/sentry-unreal/pull/143))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.52.0)
