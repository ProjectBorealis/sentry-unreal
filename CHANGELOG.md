...
- Bump Java SDK (Android) from v8.25.0 to v8.40.0 ([#78](https://github.com/ProjectBorealis/sentry-unreal/pull/78))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.40.0)
