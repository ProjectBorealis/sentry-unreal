...
- Bump Java SDK (Android) from v8.25.0 to v8.55.0 ([#159](https://github.com/ProjectBorealis/sentry-unreal/pull/159))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8550)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.55.0)
