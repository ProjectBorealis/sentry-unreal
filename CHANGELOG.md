...
- Bump Android Gradle Plugin from v5.12.1 to v6.4.0 ([#71](https://github.com/ProjectBorealis/sentry-unreal/pull/71))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#640)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.4.0)
