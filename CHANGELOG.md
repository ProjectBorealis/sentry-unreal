...
- Bump Android Gradle Plugin from v5.12.1 to v6.3.0 ([#63](https://github.com/ProjectBorealis/sentry-unreal/pull/63))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#630)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.3.0)
