...
- Bump Java SDK (Android) from v8.25.0 to v8.50.1 ([#137](https://github.com/ProjectBorealis/sentry-unreal/pull/137))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8501)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.50.1)
