...
- Bump Android Gradle Plugin from v5.12.1 to v6.0.0 ([#29](https://github.com/ProjectBorealis/sentry-unreal/pull/29))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#600)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.0.0)
