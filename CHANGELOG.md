...
- Bump Java SDK (Android) from v8.25.0 to v8.34.1 ([#51](https://github.com/ProjectBorealis/sentry-unreal/pull/51))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.34.1)
