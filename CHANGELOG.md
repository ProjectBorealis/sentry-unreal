...
- Bump Java SDK (Android) from v8.25.0 to v8.29.0 ([#19](https://github.com/ProjectBorealis/sentry-unreal/pull/19))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.29.0)
