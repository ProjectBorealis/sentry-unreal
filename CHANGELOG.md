...
- Bump Android Gradle Plugin from v5.12.1 to v6.11.0 ([#106](https://github.com/ProjectBorealis/sentry-unreal/pull/106))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6110)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.11.0)
