...
- Bump Java SDK (Android) from v8.25.0 to v8.57.0 ([#165](https://github.com/ProjectBorealis/sentry-unreal/pull/165))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8570)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.57.0)
