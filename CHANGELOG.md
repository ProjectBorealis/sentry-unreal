...
- Bump Java SDK (Android) from v8.25.0 to v8.33.0 ([#39](https://github.com/ProjectBorealis/sentry-unreal/pull/39))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.33.0)
