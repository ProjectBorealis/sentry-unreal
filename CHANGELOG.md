...
- Bump Android Gradle Plugin from v5.12.1 to v6.2.0 ([#58](https://github.com/ProjectBorealis/sentry-unreal/pull/58))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#620)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.2.0)
