...
- Bump Java SDK (Android) from v8.25.0 to v8.49.0 ([#130](https://github.com/ProjectBorealis/sentry-unreal/pull/130))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8490)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.49.0)
