...
- Bump Android Gradle Plugin from v5.12.1 to v6.15.0 ([#129](https://github.com/ProjectBorealis/sentry-unreal/pull/129))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6150)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.15.0)
