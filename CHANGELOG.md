...
- Bump Java SDK (Android) from v8.25.0 to v8.41.0 ([#86](https://github.com/ProjectBorealis/sentry-unreal/pull/86))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.41.0)
