...
- Bump Java SDK (Android) from v8.25.0 to v8.43.0 ([#98](https://github.com/ProjectBorealis/sentry-unreal/pull/98))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8430)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.43.0)
