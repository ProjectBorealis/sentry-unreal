...
- Bump Java SDK (Android) from v8.25.0 to v8.38.0 ([#70](https://github.com/ProjectBorealis/sentry-unreal/pull/70))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8380)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.38.0)
