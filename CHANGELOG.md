...
- Bump Java SDK (Android) from v8.25.0 to v8.30.0 ([#25](https://github.com/ProjectBorealis/sentry-unreal/pull/25))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.30.0)
