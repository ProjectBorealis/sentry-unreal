...
- Bump Android Gradle Plugin from v5.12.1 to v6.22.0 ([#163](https://github.com/ProjectBorealis/sentry-unreal/pull/163))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6220)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.22.0)
