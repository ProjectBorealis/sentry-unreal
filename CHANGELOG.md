...
- Bump Java SDK (Android) from v8.25.0 to v8.48.0 ([#127](https://github.com/ProjectBorealis/sentry-unreal/pull/127))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8480)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.48.0)
