...
- Bump Java SDK (Android) from v8.25.0 to v8.45.0 ([#117](https://github.com/ProjectBorealis/sentry-unreal/pull/117))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8450)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.45.0)
