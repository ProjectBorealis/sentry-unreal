...
- Bump Android Gradle Plugin from v5.12.1 to v6.17.0 ([#141](https://github.com/ProjectBorealis/sentry-unreal/pull/141))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6170)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.17.0)
