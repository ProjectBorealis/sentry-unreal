...
- Bump Android Gradle Plugin from v5.12.1 to v6.6.0 ([#83](https://github.com/ProjectBorealis/sentry-unreal/pull/83))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#660)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.6.0)
