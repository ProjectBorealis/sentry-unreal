...
- Bump Android Gradle Plugin from v5.12.1 to v6.14.0 ([#122](https://github.com/ProjectBorealis/sentry-unreal/pull/122))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6140)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.14.0)
