...
- Bump Java SDK (Android) from v8.25.0 to v8.39.1 ([#75](https://github.com/ProjectBorealis/sentry-unreal/pull/75))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8391)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.39.1)
