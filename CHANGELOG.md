...
- Bump Android Gradle Plugin from v5.12.1 to v6.18.0 ([#145](https://github.com/ProjectBorealis/sentry-unreal/pull/145))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6180)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.18.0)
