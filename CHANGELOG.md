...
- Bump Android Gradle Plugin from v5.12.1 to v6.12.0 ([#112](https://github.com/ProjectBorealis/sentry-unreal/pull/112))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6120)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.12.0)
