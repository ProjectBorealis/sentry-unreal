...
- Bump Java SDK (Android) from v8.25.0 to v8.32.0 ([#35](https://github.com/ProjectBorealis/sentry-unreal/pull/35))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8320)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.32.0)
