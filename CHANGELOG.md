...
- Bump Cocoa SDK (iOS and Mac) from v8.57.0 to v9.8.0 ([#60](https://github.com/ProjectBorealis/sentry-unreal/pull/60))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#980)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.57.0...9.8.0)
