...
- Bump Android Gradle Plugin from v5.12.1 to v6.13.0 ([#118](https://github.com/ProjectBorealis/sentry-unreal/pull/118))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6130)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.13.0)
