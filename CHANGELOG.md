...
- Bump Java SDK (Android) from v8.25.0 to v8.54.0 ([#154](https://github.com/ProjectBorealis/sentry-unreal/pull/154))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8540)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.54.0)
