...
- Bump Java SDK (Android) from v8.25.0 to v8.53.0 ([#148](https://github.com/ProjectBorealis/sentry-unreal/pull/148))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8530)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.53.0)
