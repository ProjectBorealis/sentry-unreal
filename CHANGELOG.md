...
- Bump Java SDK (Android) from v8.25.0 to v8.36.0 ([#57](https://github.com/ProjectBorealis/sentry-unreal/pull/57))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8360)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.36.0)
