...
- Bump Java SDK (Android) from v8.25.0 to v8.43.1 ([#102](https://github.com/ProjectBorealis/sentry-unreal/pull/102))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8431)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.43.1)
