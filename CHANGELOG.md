...
- Bump Android Gradle Plugin from v5.12.1 to v6.7.1 ([#92](https://github.com/ProjectBorealis/sentry-unreal/pull/92))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#671)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.7.1)
