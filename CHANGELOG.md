...
- Bump Android Gradle Plugin from v5.12.1 to v6.10.0 ([#103](https://github.com/ProjectBorealis/sentry-unreal/pull/103))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6100)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.12.1...6.10.0)
