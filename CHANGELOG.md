...
- Bump Java SDK (Android) from v8.25.0 to v8.37.1 ([#64](https://github.com/ProjectBorealis/sentry-unreal/pull/64))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8371)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.25.0...8.37.1)
